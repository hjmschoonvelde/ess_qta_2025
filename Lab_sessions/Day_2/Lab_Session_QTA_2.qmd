...
Explore `corpus_reshape()`. Reshape `speeches_inaugural_since1990`to the level of sentences and store this object as `sentences_inaug_since1990`. What is the number of sentences (= number of documents) in this text corpus?
